	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'glow': {
					'0%, 100%': { boxShadow: '0 0 5px rgba(248, 203, 46, 0.3)' },
					'50%': { boxShadow: '0 0 20px rgba(248, 203, 46, 0.6)' }
				},
				'float': {
			...
			backgroundSize: {
				'grid': '20px 20px',
				'glass-shine': '200% 100%',
				'border-animate': '200% 100%'
			},
			boxShadow: {
				'neon': '0 0 5px rgba(248, 203, 46, 0.5), 0 0 20px rgba(248, 203, 46, 0.3)',
				'glass': '0 4px 30px rgba(0, 0, 0, 0.1)',
				'glass-strong': '0 8px 32px 0 rgba(0, 0, 0, 0.36)',
				'inner-glow': 'inset 0 0 10px rgba(248, 203, 46, 0.3)'
			},
			backdropBlur: {
				'xs': '2px',
			}
